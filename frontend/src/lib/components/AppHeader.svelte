    ...
    {#if user}
      <div class="profile-menu">
        <button
          ...
          onclick={() => (showDesktopProfileMenu = !showDesktopProfileMenu)}
        >
        ...
        {#if showDesktopProfileMenu}
          ...
          <div
            ...
            role="menu"
            tabindex="-1"
            use:clickOutside={() => (showDesktopProfileMenu = false)}
          >
  ...
  <div class="mobile-actions">
    ...
    {#if user}
      <div class="profile-menu mobile">
        <button
          class="profile-trigger"
          onclick={() => (showMobileProfileMenu = !showMobileProfileMenu)}
        >
          {#if user.profilePhoto}
            <img
              src={user.profilePhoto}
        ...
        {#if showMobileProfileMenu}
          ...
          <div
            ...
            role="menu"
            tabindex="-1"
            use:clickOutside={() => (showMobileProfileMenu = false)}
          >
            <div class="dropdown-header">
              <span class="dropdown-name">{user.name}</span>
              <span class="dropdown-email">{user.email}</span>
...
<style>
  ...
  .bottom-nav-item:hover :global(.nav-icon) {
  ...
  .bottom-nav-item.active :global(.nav-icon) {
    transform: translateY(-3px) scale(1.15);
  }
