...
<div class="public-profile-page">
  <main class="main-content">
    ...
    {:else if error}
      <div class="loading-state">
        <p>{error}</p>
        <button class="btn btn-primary" onclick={() => goto("/press")}
          >Press-এ ফিরে যান</button
        >
      </div>
    {:else if profileUser}
            ...
            <div class="post-card">
              <div class="post-head">
                ...
                <div class="post-meta">
                  ...
                  <span class="post-time mono"
                    >{formatTimestamp(post.createdAt)}</span
                  >
                </div>
              </div>
