...
<script lang="ts">
  ...
  function validateFullName(value: string): string | undefined {
    if (!value.trim())
      return "Ã Â¦ÂªÃ Â§â€šÃ Â¦Â°Ã Â§ÂÃ Â¦Â£ Ã Â¦Â¨Ã Â¦Â¾Ã Â¦Â® Ã Â¦Â¦Ã Â¦Â¿Ã Â¦Â¨";
    if (value.trim().length < 2)
      return "Ã Â¦Â¨Ã Â¦Â¾Ã Â¦Â® Ã Â¦â€¢Ã Â¦Â®Ã Â¦ÂªÃ Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â§â€¡ Ã Â§Â¨ Ã Â¦â€¦Ã Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â¦Â° Ã Â¦Â¹Ã Â¦Â¤Ã Â§â€¡ Ã Â¦Â¹Ã Â¦Â¬Ã Â§â€¡";
    return undefined;
  }
  ...
  function validatePhone(value: string): string | undefined {
    ...
    if (!digits)
      return "Ã Â¦Â®Ã Â§â€¹Ã Â¦Â¬Ã Â¦Â¾Ã Â¦â€¡Ã Â¦Â² Ã Â¦Â¨Ã Â¦Â®Ã Â§ÂÃ Â¦Â¬Ã Â¦Â° Ã Â¦Â¦Ã Â¦Â¿Ã Â¦Â¨";
    if (digits.length !== 11)
      return "Ã Â¦Â¸Ã Â¦Â Ã Â¦Â¿Ã Â¦â€¢ Ã Â¦Â®Ã Â§â€¹Ã Â¦Â¬Ã Â¦Â¾Ã Â¦â€¡Ã Â¦Â² Ã Â¦Â¨Ã Â¦Â®Ã Â§ÂÃ Â¦Â¬Ã Â¦Â° Ã Â¦Â¦Ã Â¦Â¿Ã Â¦Â¨ (01XXXXXXXXX)";
    if (!/^01[3-9]/.test(digits))
      return "Ã Â¦Â®Ã Â§â€¹Ã Â¦Â¬Ã Â¦Â¾Ã Â¦â€¡Ã Â¦Â² Ã Â¦Â¨Ã Â¦Â®Ã Â§ÂÃ Â¦Â¬Ã Â¦Â° 013-019 Ã Â¦Â¦Ã Â¦Â¿Ã Â¦Â¯Ã Â¦Â¼Ã Â§â€¡ Ã Â¦Â¶Ã Â§ÂÃ Â¦Â°Ã Â§Â Ã Â¦Â¹Ã Â¦Â¤Ã Â§â€¡ Ã Â¦Â¹Ã Â¦Â¬Ã Â§â€¡";
    return undefined;
  }
  ...
  function validateEmail(value: string): string | undefined {
    ...
    if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value))
      return "Ã Â¦Â¸Ã Â¦Â Ã Â¦Â¿Ã Â¦â€¢ Ã Â¦â€¡Ã Â¦Â®Ã Â§â€¡Ã Â¦â€¡Ã Â¦Â² Ã Â¦Â«Ã Â¦Â°Ã Â¦Â®Ã Â§ÂÃ Â¦Â¯Ã Â¦Â¾Ã Â¦Å¸ Ã Â¦Â¦Ã Â¦Â¿Ã Â¦Â¨";
    return undefined;
  }

  function validatePassword(value: string): string | undefined {
    if (!value)
      return "Ã Â¦ÂªÃ Â¦Â¾Ã Â¦Â¸Ã Â¦â€œÃ Â¦Â¯Ã Â¦Â¼Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â¡ Ã Â¦Â¦Ã Â¦Â¿Ã Â¦Â¨";
    if (value.length < 8)
      return "Ã Â¦ÂªÃ Â¦Â¾Ã Â¦Â¸Ã Â¦â€œÃ Â¦Â¯Ã Â¦Â¼Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â¡ Ã Â¦â€¢Ã Â¦Â®Ã Â¦ÂªÃ Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â§â€¡ Ã Â§Â® Ã Â¦â€¦Ã Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â¦Â° Ã Â¦Â¹Ã Â¦Â¤Ã Â§â€¡ Ã Â¦Â¹Ã Â¦Â¬Ã Â§â€¡";
    return undefined;
  }

  function validateConfirmPassword(value: string): string | undefined {
    if (!value)
      return "Ã Â¦ÂªÃ Â¦Â¾Ã Â¦Â¸Ã Â¦â€œÃ Â¦Â¯Ã Â¦Â¼Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â¡ Ã Â¦Â¨Ã Â¦Â¿Ã Â¦Â¶Ã Â§ÂÃ Â¦Å¡Ã Â¦Â¿Ã Â¦Â¤ Ã Â¦â€¢Ã Â¦Â°Ã Â§ÂÃ Â¦Â¨";
    if (value !== password)
      return "Ã Â¦ÂªÃ Â¦Â¾Ã Â¦Â¸Ã Â¦â€œÃ Â¦Â¯Ã Â¦Â¼Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â¡ Ã Â¦Â®Ã Â¦Â¿Ã Â¦Â²Ã Â¦â€ºÃ Â§â€¡ Ã Â¦Â¨Ã Â¦Â¾";
    return undefined;
  }
  ...
  function validateForm(): boolean {
    ...
    const termsError = !acceptTerms
      ? "Ã Â¦Â¶Ã Â¦Â°Ã Â§ÂÃ Â¦Â¤Ã Â¦Â¾Ã Â¦Â¬Ã Â¦Â²Ã Â§â‚¬ Ã Â¦Â®Ã Â§â€¡Ã Â¦Â¨Ã Â§â€¡ Ã Â¦Å¡Ã Â¦Â²Ã Â¦Â¤Ã Â§â€¡ Ã Â¦Â°Ã Â¦Â¾Ã Â¦Å“Ã Â¦Â¿ Ã Â¦Â¹Ã Â¦Â¤Ã Â§â€¡ Ã Â¦Â¹Ã Â¦Â¬Ã Â§â€¡"
      : undefined;
  ...
  async function handleSubmit(e: Event) {
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 429) {
          showModalMessage(
            ...
            "Ã Â¦â€¦Ã Â¦Â¨Ã Â§â€¡Ã Â¦â€¢ Ã Â¦Â¬Ã Â§â€¡Ã Â¦Â¶Ã Â¦Â¿ Ã Â¦Å¡Ã Â§â€¡Ã Â¦Â·Ã Â§ÂÃ Â¦Å¸Ã Â¦Â¾ - Ã Â§Â§ Ã Â¦Â®Ã Â¦Â¿Ã Â¦Â¨Ã Â¦Â¿Ã Â¦Å¸ Ã Â¦â€¦Ã Â¦ÂªÃ Â§â€¡Ã Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â¦Â¾ Ã Â¦â€¢Ã Â¦Â°Ã Â§ÂÃ Â¦Â¨",
            "error",
          );
          return;
        }
        ...
        if (errorMessage.includes("Email") || errorMessage.includes("email")) {
          errors.email =
            "Ã Â¦ÂÃ Â¦â€¡ Ã Â¦â€¡Ã Â¦Â®Ã Â§â€¡Ã Â¦â€¡Ã Â¦Â²Ã Â¦Å¸Ã Â¦Â¿ Ã Â¦â€¡Ã Â¦Â¤Ã Â¦Â¿Ã Â¦Â®Ã Â¦Â§Ã Â§ÂÃ Â¦Â¯Ã Â§â€¡ Ã Â¦Â¨Ã Â¦Â¿Ã Â¦Â¬Ã Â¦Â¨Ã Â§ÂÃ Â¦Â§Ã Â¦Â¿Ã Â¦Â¤";
          return;
        }
        if (errorMessage.includes("phone") || errorMessage.includes("Phone")) {
          errors.phone =
            "Ã Â¦ÂÃ Â¦â€¡ Ã Â¦Â®Ã Â§â€¹Ã Â¦Â¬Ã Â¦Â¾Ã Â¦â€¡Ã Â¦Â² Ã Â¦Â¨Ã Â¦Â®Ã Â§ÂÃ Â¦Â¬Ã Â¦Â°Ã Â¦Å¸Ã Â¦Â¿ Ã Â¦â€¡Ã Â¦Â¤Ã Â¦Â¿Ã Â¦Â®Ã Â¦Â§Ã Â§ÂÃ Â¦Â¯Ã Â§â€¡ Ã Â¦Â¨Ã Â¦Â¿Ã Â¦Â¬Ã Â¦Â¨Ã Â§ÂÃ Â¦Â§Ã Â¦Â¿Ã Â¦Â¤";
          return;
        }
        ...
        showModalMessage(
          ...
          errorMessage ||
            "Ã Â¦Â¸Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â­Ã Â¦Â¾Ã Â¦Â°Ã Â§â€¡ Ã Â¦Â¸Ã Â¦Â®Ã Â¦Â¸Ã Â§ÂÃ Â¦Â¯Ã Â¦Â¾ Ã Â¦Â¹Ã Â¦Â¯Ã Â¦Â¼Ã Â§â€¡Ã Â¦â€ºÃ Â§â€¡",
          "error",
        );
        return;
      }
      ...
      if (error instanceof TypeError && error.message === "Failed to fetch") {
        ...
        showModalMessage(
          "Ã Â¦Â¤Ã Â§ÂÃ Â¦Â°Ã Â§ÂÃ Â¦Å¸Ã Â¦Â¿",
          "Ã Â¦â€¦Ã Â¦ÂªÃ Â§ÂÃ Â¦Â°Ã Â¦Â¤Ã Â§ÂÃ Â¦Â¯Ã Â¦Â¾Ã Â¦Â¶Ã Â¦Â¿Ã Â¦Â¤ Ã Â¦Â¸Ã Â¦Â®Ã Â¦Â¸Ã Â§ÂÃ Â¦Â¯Ã Â¦Â¾ Ã Â¦Â¹Ã Â¦Â¯Ã Â¦Â¼Ã Â§â€¡Ã Â¦â€ºÃ Â§â€¡Ã Â¥Â¤ Ã Â¦â€ Ã Â¦Â¬Ã Â¦Â¾Ã Â¦Â° Ã Â¦Å¡Ã Â§â€¡Ã Â¦Â·Ã Â§ÂÃ Â¦Å¸Ã Â¦Â¾ Ã Â¦â€¢Ã Â¦Â°Ã Â§ÂÃ Â¦Â¨Ã Â¥Â¤",
          "error",
        );
      }
    } finally {
...
{#if isCheckingAuth}
  <div class="auth-check-loading">
    ...
    <p>
      ...
      Ã Â¦Â¹Ã Â¦Å¡Ã Â§ÂÃ Â¦â€ºÃ Â§â€¡...
    </p>
  </div>
{:else}
  <div class="register-page">
    ...
    <div class="brand-header">
      ...
      <p class="brand-tagline">
        ...
        Ã Â¦â€¡Ã Â¦â€°Ã Â¦Â¨Ã Â¦Â¾Ã Â¦â€¡Ã Â¦Å¸Ã Â§â€¡Ã Â¦Â¡ Ã Â¦Â«Ã Â¦Â°
        Ã Â¦Å¡Ã Â§â€¡Ã Â¦Å¾Ã Â§ÂÃ Â¦Å“
      </p>
    </div>
    ...
    <div class="register-card">
      <h1 class="heading">
        Ã Â¦â€¦Ã Â§ÂÃ Â¦Â¯Ã Â¦Â¾Ã Â¦â€¢Ã Â¦Â¾Ã Â¦â€°Ã Â¦Â¨Ã Â§ÂÃ Â¦Å¸
        Ã Â¦â€“Ã Â§ÂÃ Â¦Â²Ã Â§ÂÃ Â¦Â¨
      </h1>
      <p class="subheading">
        UnityPulse-Ã Â¦Â Ã Â¦Â¸Ã Â§ÂÃ Â¦Â¬Ã Â¦Â¾Ã Â¦â€”Ã Â¦Â¤Ã Â¦Â®
      </p>
      ...
      <form onsubmit={handleSubmit} novalidate>
        ...
        <div class="form-group">
          <label for="fullName" class="form-label"
            >Ã°Å¸â€˜Â¤ Ã Â¦ÂªÃ Â§â€šÃ Â¦Â°Ã Â§ÂÃ Â¦Â£ Ã Â¦Â¨Ã Â¦Â¾Ã Â¦Â®</label
          >
          <input
            type="text"
            id="fullName"
            ...
            class:input-valid={touched.fullName &&
              !errors.fullName &&
              fullName.length > 0}
        ...
        <div class="form-group">
          <label for="phone" class="form-label"
            ...
            Ã Â¦Â¨Ã Â¦Â®Ã Â§ÂÃ Â¦Â¬Ã Â¦Â°</label
          >
          <input
            type="tel"
            id="phone"
            ...
            class:input-valid={touched.phone &&
              !errors.phone &&
              phone.length > 0}
          ...
          />
          <p class="hint-text">
            Ã Â¦â€°Ã Â¦Â¦Ã Â¦Â¾Ã Â¦Â¹Ã Â¦Â°Ã Â¦Â£: 01712345678
          </p>
        ...
        <div class="form-group">
          <label for="email" class="form-label"
            >Ã°Å¸â€œÂ§ Ã Â¦â€¡Ã Â¦Â®Ã Â§â€¡Ã Â¦â€¡Ã Â¦Â²
            Ã Â¦â€¦Ã Â§ÂÃ Â¦Â¯Ã Â¦Â¾Ã Â¦Â¡Ã Â§ÂÃ Â¦Â°Ã Â§â€¡Ã Â¦Â¸</label
          >
          <input
            type="email"
            id="email"
        ...
        <div class="form-group">
          <label for="password" class="form-label"
            >Ã°Å¸â€â€™
            Ã Â¦ÂªÃ Â¦Â¾Ã Â¦Â¸Ã Â¦â€œÃ Â¦Â¯Ã Â¦Â¼Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â¡</label
          >
          <div class="input-wrapper">
            <input
              ...
              class:input-valid={touched.password &&
                !errors.password &&
                password.length > 0}
          ...
          {#if password.length > 0}
            ...
            <div class="checklist">
              <div class="checklist-item" class:met={passwordChecks.minLength}>
                {#if passwordChecks.minLength}<CheckCircle2
                    size={14}
                  />{:else}<XCircle size={14} />{/if}
                <span
                  >Ã Â¦â€¢Ã Â¦Â®Ã Â¦ÂªÃ Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â§â€¡ Ã Â§Â®
                  Ã Â¦â€¦Ã Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â¦Â°</span
                >
              </div>
              <div
              ...
              >
                {#if passwordChecks.hasUpperCase}<CheckCircle2
                    size={14}
                  />{:else}<XCircle size={14} />{/if}
                <span
                  >Ã Â¦Â¬Ã Â¦Â¡Ã Â¦Â¼ Ã Â¦Â¹Ã Â¦Â¾Ã Â¦Â¤Ã Â§â€¡Ã Â¦Â°
                  Ã Â¦â€¦Ã Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â¦Â° (A-Z)</span
                >
              </div>
              <div
                class="checklist-item"
              ...
              >
                {#if passwordChecks.hasLowerCase}<CheckCircle2
                    size={14}
                  />{:else}<XCircle size={14} />{/if}
                <span
                  >Ã Â¦â€ºÃ Â§â€¹Ã Â¦Å¸ Ã Â¦Â¹Ã Â¦Â¾Ã Â¦Â¤Ã Â§â€¡Ã Â¦Â°
                  Ã Â¦â€¦Ã Â¦â€¢Ã Â§ÂÃ Â¦Â·Ã Â¦Â° (a-z)</span
                >
              </div>
              <div class="checklist-item" class:met={passwordChecks.hasNumber}>
                {#if passwordChecks.hasNumber}<CheckCircle2
                    size={14}
                  />{:else}<XCircle size={14} />{/if}
                <span>Ã Â¦Â¸Ã Â¦â€šÃ Â¦â€“Ã Â§ÂÃ Â¦Â¯Ã Â¦Â¾ (0-9)</span>
              </div>
              <div class="checklist-item" class:met={passwordChecks.hasSpecial}>
                {#if passwordChecks.hasSpecial}<CheckCircle2
                    size={14}
                  />{:else}<XCircle size={14} />{/if}
                <span
                  >Ã Â¦Â¬Ã Â¦Â¿Ã Â¦Â¶Ã Â§â€¡Ã Â¦Â· Ã Â¦Å¡Ã Â¦Â¿Ã Â¦Â¹Ã Â§ÂÃ Â¦Â¨
        ...
        <div class="form-group">
          <label for="confirmPassword" class="form-label"
            >Ã°Å¸â€Â
            Ã Â¦ÂªÃ Â¦Â¾Ã Â¦Â¸Ã Â¦â€œÃ Â¦Â¯Ã Â¦Â¼Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â¡
            Ã Â¦Â¨Ã Â¦Â¿Ã Â¦Â¶Ã Â§ÂÃ Â¦Å¡Ã Â¦Â¿Ã Â¦Â¤ Ã Â¦â€¢Ã Â¦Â°Ã Â§ÂÃ Â¦Â¨</label
          >
          <div class="input-wrapper">
            <input
              ...
              id="confirmPassword"
              class="form-input"
              class:input-error={touched.confirmPassword &&
                errors.confirmPassword}
              class:input-valid={touched.confirmPassword &&
                !errors.confirmPassword &&
            ...
            <button
              ...
              tabindex="-1"
            >
              {#if showConfirmPassword}<EyeOff size={18} />{:else}<Eye
                  size={18}
                />{/if}
            </button>
          </div>
          {#if touched.confirmPassword && confirmPassword.length > 0 && !errors.confirmPassword}
            <p class="success-text">
              <CheckCircle2 size={14} /> Ã Â¦ÂªÃ Â¦Â¾Ã Â¦Â¸Ã Â¦â€œÃ Â¦Â¯Ã Â¦Â¼Ã Â¦Â¾Ã Â¦Â°Ã Â§ÂÃ Â¦Â¡
              Ã Â¦Â®Ã Â¦Â¿Ã Â¦Â²Ã Â§â€¡Ã Â¦â€ºÃ Â§â€¡
            </p>
          {/if}
        ...
        <div class="terms-group">
          <label class="terms-label">
            ...
            <span class="terms-text">
              Ã Â¦â€ Ã Â¦Â®Ã Â¦Â¿ <a href="/terms" target="_blank"
                >Ã Â¦Â¶Ã Â¦Â°Ã Â§ÂÃ Â¦Â¤Ã Â¦Â¾Ã Â¦Â¬Ã Â¦Â²Ã Â§â‚¬</a
              >
              Ã Â¦â€œ
              <a href="/privacy" target="_blank"
                >Ã Â¦â€”Ã Â§â€¹Ã Â¦ÂªÃ Â¦Â¨Ã Â§â‚¬Ã Â¦Â¯Ã Â¦Â¼Ã Â¦Â¤Ã Â¦Â¾
                Ã Â¦Â¨Ã Â§â‚¬Ã Â¦Â¤Ã Â¦Â¿</a
              > Ã Â¦Â®Ã Â§â€¡Ã Â¦Â¨Ã Â§â€¡ Ã Â¦Å¡Ã Â¦Â²Ã Â¦Â¤Ã Â§â€¡ Ã Â¦Â°Ã Â¦Â¾Ã Â¦Å“Ã Â¦Â¿
              Ã Â¦â€ Ã Â¦â€ºÃ Â¦Â¿
            </span>
          </label>
          {#if errors.terms}
        ...
        <button type="submit" class="register-btn" disabled={isLoading}>
          {#if isLoading}
            ...
            <span
              >Ã Â¦Â°Ã Â§â€¡Ã Â¦Å“Ã Â¦Â¿Ã Â¦Â¸Ã Â§ÂÃ Â¦Å¸Ã Â§ÂÃ Â¦Â°Ã Â§â€¡Ã Â¦Â¶Ã Â¦Â¨
              Ã Â¦Â¹Ã Â¦Å¡Ã Â§ÂÃ Â¦â€ºÃ Â§â€¡...</span
            >
          {:else}
            <span
              >Ã°Å¸â€œÂ
              Ã Â¦Â°Ã Â§â€¡Ã Â¦Å“Ã Â¦Â¿Ã Â¦Â¸Ã Â§ÂÃ Â¦Å¸Ã Â§ÂÃ Â¦Â°Ã Â§â€¡Ã Â¦Â¶Ã Â¦Â¨
              Ã Â¦â€¢Ã Â¦Â°Ã Â§ÂÃ Â¦Â¨</span
            >
          {/if}
        </button>
      </form>
