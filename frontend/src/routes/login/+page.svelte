  ...
  async function handleSubmit(e: Event) {
    ...
    try {
      ...
      if (error instanceof TypeError && error.message === "Failed to fetch") {
        ...
        const message =
          error instanceof Error ? error.message : labels.serverError;

        // Professional field-specific errors
        if (
          message.includes("Email") ||
          message.includes("email") ||
          message.includes("ইমেইল")
        ) {
          if (
            message.includes("registered") ||
            message.includes("account") ||
            message.includes("পাওয়া") ||
            message.includes("নেই")
          ) {
    ...
    <div class="login-card">
      ...
      <form onsubmit={handleSubmit} novalidate>
        ...
        <div class="form-options">
          ...
          <a href="/forgot-password" class="forgot-password-btn">
