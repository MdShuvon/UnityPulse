  ...
  <main class="main-content">
    <div class="page-hero">
      ...
      <div class="hero-content">
        ...
        <h1 class="hero-title">শীর্ষ পারফর্মার</h1>
        <p class="hero-sub bangla">সবচেয়ে বেশি পয়েন্ট অর্জনকারী সদস্যদের তালিকা</p>
      </div>
    </div>
        ...
        {#each leaders.slice(3) as leader, i}
          <div class="leader-item">
            ...
            <div class="leader-info">
              ...
              <span class="leader-org bangla"
                >{leader.user?.occupation || "সদস্য"}</span
              >
            </div>
            <span class="leader-points mono"
              >{formatPoints(leader.totalPoints || 0)} pts</span
            >
          </div>
        {/each}
      </div>
...
.leaderboard-page .page-hero { background: linear-gradient(135deg, #8E44AD, #153F36); }
