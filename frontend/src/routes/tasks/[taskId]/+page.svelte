    ...
    {:else if task}
      <div class="task-detail-card">
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <span class="info-value mono"
                >{task._count?.submissions || 0} টি</span
              >
            </div>
          </div>
        </div>
        ...
        {#if task.mySubmission}
          <div class="submission-status">
            <div class="status-header">
              ...
              <span
                class="status-badge"
                class:approved={task.mySubmission.status === "APPROVED"}
                class:rejected={task.mySubmission.status === "REJECTED"}
              >
        ...
        <button
          ...
          disabled={task.mySubmission?.status === "PENDING" ||
