      ...
      <div class="job-detail-card">
        <div class="job-header">
          ...
          <p class="job-department">
            {job.department || "UnityPulse Foundation"}
          </p>

          <div class="job-meta-row">
            <span class="meta-item"
              ><MapPin size={14} /> {job.location || "Bangladesh"}</span
            >
            <span class="meta-item"
              ><Briefcase size={14} /> {job.jobType || "Full-time"}</span
            >
            {#if job.experience}
        ...
        <div class="job-section">
          ...
          <p class="section-content bangla" style="white-space: pre-line;">
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <span class="info-value mono"
                >{formatFee(job.applicationFee)}</span
              >
            </div>
            <div class="info-item">
        ...
        {#if job.applicationFee > 0}
          <div class="fee-notice">
            <span class="fee-note bangla"
              >⚠️ আবেদন ফি <strong>অ-ফেরতযোগ্য</strong>।</span
            >
          </div>
        {/if}
